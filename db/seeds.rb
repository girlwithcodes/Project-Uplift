...
Post.create(content: "You don’t just give up. You don’t just let things happen. You make a stand! You say no! You have the guts to do what’s right, even when everyone else just runs away.", background_color: "#ff1100", font: "Arial", font_color: "#000000", board: board3, is_public: true, post_type: "quote", user_id: user2.id, font_size: 20)
